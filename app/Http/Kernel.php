...
use App\Http\Support\Middleware\TrimStrings;
use App\Http\Support\Middleware\TrustProxies;
use App\Http\Support\Middleware\VerifyCsrfToken;
...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        // \App\Http\Support\Middleware\TrustHosts::class,
        TrustProxies::class,
        HandleCors::class,
