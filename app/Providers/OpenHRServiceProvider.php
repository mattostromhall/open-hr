...
class OpenHRServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(ReassignManagerFromPersonActionInterface::class, ReassignManagerFromPersonAction::class);
        $this->app->bind(RemovePersonActionInterface::class, RemovePersonAction::class);
